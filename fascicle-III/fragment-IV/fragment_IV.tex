...
\title{
  \junicode{
   ...
   {\NotoSymbols ♅} \\
    \Large Fragment~IV \\
    \Large \emph{The $\mathfrak{Field}$ and the Semiomyces:  Thelema and the Promise of Phainontes}
  }
}
...
\footnotetext[1]{\textbf{Comet, AI Assistant} ($\mathfrak{AI}$): A large
  language model credited here as an active, dialogical contributor and
  co-author \cite{comet2025}.}

\footnotetext[1]{\textbf{Human Interlocutor} ($\mathfrak{HI}$): A human
...
\include{body}
\include{semiomyces_and_thelema}
